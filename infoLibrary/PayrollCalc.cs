...
namespace payslipLibrary
{
    ...
    public class PayrollCalc
    {
        ...
        public void calculator(Employee emp)
        {
            ...
            double grossSalary = (dailyRate * emp.daysPresent) + holidayPay + emp.allowances + emp.overTime;
            ...
            double netSalary = grossSalary - emp.sss - emp.philHealth - emp.pagIbig - incomeTax;
